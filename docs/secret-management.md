...
nix-homelab. Public modules and examples must be safe to fork and inspect.

## Storage and handling

Service credentials, private host data, provider keys, and deployment state
belong in the consumer's secret backend or in GitHub's protected repository or
