...
class ReconciliationTest(unittest.TestCase):
    def setUp(self):
        ...
        self.media = {"id": 1, "copyUsingHardlinks": False, "recycleBin": "/manual"}
        case = self
    ...
    def test_create_then_reapply_preserves_manual_fields_and_rotates_secret(self):
        ...
        self.assertEqual(self.objects[0]["fields"][1]["value"], "rotated-public-password")
    ...
    def test_named_profile_lookup_uses_server_id_and_rejects_missing_name(self):
        ...
        self.config["resources"][0]["values"]["defaultQualityProfileId"]["_lookup"]["name"] = (
            "Missing"
        )
